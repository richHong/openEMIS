...
$dropdown = array(
	'About' => array('url' => array('plugin' => false, 'controller' => 'Dashboard'), 'icon' => 'fa-info-circle'),
	'Preferences' => array('url' => array('plugin' => false, 'controller' => 'Preferences'), 'icon' => 'fa-cog'),
	'_divider',
	'Logout' => array('url' => array('plugin' => false, 'controller' => 'Users', 'action' => 'logout'), 'icon' => 'fa-power-off')
);

$home = array('controller' => 'Dashboard', 'action' => 'index');
?>
