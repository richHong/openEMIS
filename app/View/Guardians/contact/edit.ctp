...
<div class="tab-content">
    ...
    //echo $this->Form->hidden('staff_id', array('value' => $relatedModelId));
    ...
    echo $this->Form->input(
        ...
        array(
            ...
            'options' => $descOptions,
            'default' => $data['GuardianContact']['contact_type_id']
        )
    );
    
    echo $this->Form->input('value', array('id' => 'value', 'value' => $data['GuardianContact']['value']));
    ...
    echo $this->Form->input(
        ...
        array(
            ...
            'options' => $mainOptions,
            'default' => $data['GuardianContact']['main']
        )
    );
...
echo $this->element('layout/deleteModal', array('url' => $url, 'model' => 'GuardianContact'));
?>
