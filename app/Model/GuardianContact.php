...
class GuardianContact extends AppModel {
	...
	public function beforeAction() {
		...
		$this->Navigation->addCrumb($this->Message->getLabel('Contact.title'));
		$this->fields['security_user_id']['type'] = 'hidden';
		$this->fields['security_user_id']['value'] = $this->Session->read('StudentGuardian.data.SecurityUser.id');
