...
class StaffPassword extends AppModel {
	...
	public function index() {
		...
		$securityUserData = $this->find(
			'first', array(
				'recursive' => 0,
				'fields' => array(
					'StaffPassword.id', 'StaffPassword.security_user_id',  'SecurityUser.id', 'SecurityUser.username', 'SecurityUser.password'
				),
				'conditions' => array (
					'StaffPassword.id' => $staffId
				)
			)
		);
