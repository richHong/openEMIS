...
class StaffEmployment extends AppModel {
	...
	public $actsAs = array(
		'ControllerAction',
		'DatePicker' => array('employment_date'),
    ...
    public function __construct() {
        ...
        $this->validate = array(
            ...
            'staff_employment_type_id' => array(
                'ruleRequired' => array(
                    'rule' => 'notEmpty',
                    'required' => true,
                    'message' => $this->getErrorMessage('staff_employment_type_id')
                )
            )
        );
    }
