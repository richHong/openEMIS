...
class GuardianCustomField extends AppModel {
	public $roleModel = 'Guardian';
	public $actsAs = array('CustomField' => array('module' => 'Guardian'));
	...
	public $hasMany = array(
		'GuardianCustomFieldOption' => array(
			'className' => 'GuardianCustomFieldOption',
			'foreignKey' => 'guardian_custom_field_id',
		),
		'GuardianCustomValue' => array(
			'className' => 'GuardianCustomValue',
			'foreignKey' => 'guardian_custom_field_id',
		)
	);
