...
class StaffCustomField extends AppModel {
	public $roleModel = 'Staff';
	public $actsAs = array('CustomField' => array('module' => 'Staff'));
	...
	public $hasMany = array(
		'StaffCustomFieldOption' => array(
			'className' => 'StaffCustomFieldOption',
			'foreignKey' => 'staff_custom_field_id',
		),
		'StaffCustomValue' => array(
			'className' => 'StaffCustomValue',
			'foreignKey' => 'staff_custom_field_id',
		)
	);
